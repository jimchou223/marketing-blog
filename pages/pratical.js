...
const blogs = ({ blogs, categories }) => {
  ...
  useEffect(() => {
    let hashArray = [];
    blogs.filter((el) => el.blog_category.name === "實務操作").map((blog, index) => {
  ...
  searchResult = blogs.filter((el) => el.blog_category.name === "實務操作");
  const searchHandler = () => {
    if (keyword !== "") {
      setSearched(true);
    }
      ...
      <div className={styles.blogsWrapper}>
        <div className={styles.articlesContainer}>
          <div className={styles.opening}>
            <h1>文章列表-實務操作</h1>
            <p>吳董還欠我一段實務操作的屁話，吳董還欠我一段屁話，吳董還欠我一段屁話吳董還欠我一段屁話，吳董還欠我一段屁話，吳董還欠我一段屁話吳董還欠我一段屁話，吳董還欠我一段屁話，吳董還欠我一段屁話，放在這裡</p>
          </div>
